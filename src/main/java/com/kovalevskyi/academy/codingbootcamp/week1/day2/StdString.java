...
public class StdString implements Iterable<Character> {
  ...
  public boolean equals(final Object otherObj) {
    ...
    return Arrays.equals(this.base, stdString.base);
  }
   ...
   *
   * @return Iterator instance of StdString
   */
  @Override
  public Iterator<Character> iterator() {
    return new StdStringIterator();
  }
  ...
  private class StdStringIterator implements Iterator<Character> {

    private int iteratorElement = 0;

    @Override
    public boolean hasNext() {
      return iteratorElement < StdString.this.length();
    }

    @Override
    public Character next() {
      if (iteratorElement == StdString.this.length()) {
        throw new NoSuchElementException();
      }
      return StdString.this.charAt(iteratorElement++);
    }
  }
}